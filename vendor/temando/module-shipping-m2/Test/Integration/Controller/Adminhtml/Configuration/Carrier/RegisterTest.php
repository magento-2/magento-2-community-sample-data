 ...
 */
class RegisterTest extends AbstractBackendController
{
    /**
     ...
     * @var string
     */
    protected $uri = 'backend/temando/configuration_carrier/register';
    ...
    public function pageIsRendered()
    {
        ...
        $this->assertContains('CarrierRegistration', $this->getResponse()->getBody());
    }
