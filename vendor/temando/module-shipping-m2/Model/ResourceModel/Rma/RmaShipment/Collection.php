 ...
 */
namespace Temando\Shipping\Model\ResourceModel\Rma\RmaShipment;
...
/**
 * Temando RMA Shipment Resource Collection
 *
...
class Collection extends ApiCollection
{
    ...
    {
        $shipments = $this->rmaShipmentRepository->getShipments($criteria);
